...
(function ($) {
    ...
    function Timepicker() {
        ...
        this._defaults = { // Global defaults for all the time picker instances
            ...
            afterShow: null,                // Define a callback function executed after the timepicker is shown
    ...
    $.extend(Timepicker.prototype, {
        ...
        _showTimepicker: function (input) {
            ...
            if ( ! inst.inline ) {
                ...
                var afterShow = $.timepicker._get(inst, 'afterShow');
                extendRemove(inst.settings, (afterShow ? afterShow.apply(input, [input, inst]) : {}));
            }
        },
